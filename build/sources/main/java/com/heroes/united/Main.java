...
public class Main {
    ...
    public static final String VERSION = "1.0.0-PREALPHA";
    public static final Logger LOGGER = LogManager.getLogger("heroesunited");
    public static final CreativeTabs CREATIVE_TAB = new CreativeTabs("heroes") {
    ...
    @SidedProxy(clientSide = "com.heroes.united.client.ClientProxy", serverSide = "com.heroes.united.common.CommonProxy")
    public static CommonProxy PROXY;

    @Mod.EventHandler
    public void onPreInit(FMLPreInitializationEvent event) {
        Main.PROXY.onPreInit();
    }
